$(function () {
    ...
    if ($("#hfPunchedInTime").val() != "" && $("#hfPunchedOutTime").val()) {
        // create slider  
        $x('#slider').slider({
            ...
            // current data
            handles: [{
                value: parseFloat($("#hfPunchedInTime").val() != "" ? $("#hfPunchedInTime").val() : "0"),
                type: "Punched Time:"
            },
            {
                value: parseFloat($("#hfPunchedOutTime").val() != "" ? $("#hfPunchedOutTime").val() : "0"),
                type: "Punched Time:"
            }],
            // display type names
            showTypeNames: true,
            typeNames: {
                'Punched Time:': 'Punched Time:',
            },
