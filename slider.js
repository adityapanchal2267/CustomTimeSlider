...
(function($) {
    ...
    $.widget('ui.slider', $.ui.mouse, {
        ...
        _refreshHandles: function() {
            ...
            if (o.handles && o.handles.length) {                
                ...
                $.each(o.handles, function(i) {
                    ...
                    .attr('data-id', i)
                    .attr('data-value', o.handles[i].value.toFixed(2))
                    .attr('title', o.handles[i].value.toFixed(2))
                    .addClass('ui-state-default'
                        + ' ui-corner-all');

                    handle.append('<span class="tooltiptext">' + o.handles[i].value.toFixed(2) + '</span>');
        ...
        _activateHandle: function(index) {
            ...
            // get value
            var value = parseFloat(handle.attr('data-value')).toFixed(2);
            // get type
        ...
        _refreshValue: function(animate) {
            ...
            if (numOptions) {
                ...
                this.handles.each(function(i, j) {
                    ...
                    $(this).attr('data-value', self.values(i).toFixed(2));
                    o.handles[i].value = self.values(i).toFixed(2);
                    ...
                    if (o.tooltips) {
                        ...
                        if (i < allHandles.length-1) {
                            ...
                            if (o.type == 'number')
                                text += ' ' + parseFloat($(this).attr('data-value')).toFixed(2) + ' - ' + parseFloat(allHandles.eq(i + 1).attr('data-value')).toFixed(2);
                            else if (o.type == 'time')
                                text += ' ' + self._getTimeStringFromFloat(parseFloat($(this).attr('data-value')).toFixed(2)) + ' - ' + self._getTimeStringFromFloat(parseFloat(allHandles.eq(i + 1).attr('data-value')).toFixed(2));
                        }
                        // if last show range from previous
                            ...
                            if (o.type == 'number')
                                text += ' ' + parseFloat($(this).attr('data-value')).toFixed(2)+' - '+o.max;
                            if (o.type == 'time')
                                text += ' ' + self._getTimeStringFromFloat(parseFloat($(this).attr('data-value')).toFixed(2)) + ' - 0:00';
                        }
